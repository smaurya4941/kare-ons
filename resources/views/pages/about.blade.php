...
<h1 class="font-display-lg text-display-lg-mobile md:text-display-lg md:leading-tight text-on-surface mb-6">
...
<h2 class="font-headline-md text-headline-md md:text-display-lg text-on-surface mb-4">
...
<!-- Pillar 1 -->
<div class="bg-surface-bright border border-soft-border rounded-xl p-6 hover:border-primary hover:shadow-[0_8px_24px_rgba(27,58,24,0.10)] transition-all duration-300 group">
