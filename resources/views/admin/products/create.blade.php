...
<form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4 max-w-full">
    @csrf
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm @error('name') border-red-500 @enderror">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="sku" id="sku" value="{{ old('sku') }}" required class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 uppercase shadow-sm @error('sku') border-red-500 @enderror">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="pack_size" id="pack_size" value="{{ old('pack_size') }}" placeholder="e.g. 60 Tablets" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm @error('pack_size') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <textarea name="short_description" id="short_description" rows="2" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('short_description') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" required class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                ...
                <div class="space-y-3">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <textarea name="ingredients" id="ingredients" rows="2" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('ingredients') }}</textarea>
                        </div>
                        <div>
                            <label for="benefits" class="block text-[10px] font-medium text-gray-700 mb-1 uppercase tracking-wider">Health Benefits</label>
                            <textarea name="benefits" id="benefits" rows="2" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('benefits') }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="usage_instructions" id="usage_instructions" rows="2" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('usage_instructions') }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="storage_instructions" id="storage_instructions" rows="2" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('storage_instructions') }}</textarea>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <textarea name="ayurvedic_reference" id="ayurvedic_reference" rows="2" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('ayurvedic_reference') }}</textarea>
                        </div>
                        <div>
                            <label for="suitable_for" class="block text-[10px] font-medium text-gray-700 mb-1 uppercase tracking-wider">Suitable For</label>
                            <textarea name="suitable_for" id="suitable_for" rows="2" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('suitable_for') }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="precautions" id="precautions" rows="2" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('precautions') }}</textarea>
                        </div>
                        <div>
                            <label for="disclaimer" class="block text-[10px] font-medium text-gray-700 mb-1 uppercase tracking-wider">Disclaimer</label>
                            <textarea name="disclaimer" id="disclaimer" rows="2" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('disclaimer') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div>
                        ...
                        <input type="number" step="0.01" name="price" id="price" value="{{ old('price') }}" required class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm @error('price') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="sale_price" id="sale_price" value="{{ old('sale_price') }}" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm @error('sale_price') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="stock_quantity" id="stock_quantity" value="{{ old('stock_quantity', 0) }}" required min="0" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm @error('stock_quantity') border-red-500 @enderror">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <input type="text" name="seo_title" id="seo_title" value="{{ old('seo_title') }}" placeholder="Falls back to the product name" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">
                    </div>
                    <div>
                        ...
                        <textarea name="seo_description" id="seo_description" rows="2" maxlength="500" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('seo_description') }}</textarea>
                    </div>
                    <label class="flex items-center pt-1">
                        <input type="checkbox" name="is_indexable" value="1" {{ old('is_indexable', true) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 w-3.5 h-3.5">
                        <span class="ml-2 text-[11px] text-gray-700">Allow search engines to index this product</span>
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-4">
                ...
                <div class="space-y-3">
                    ...
                    <div class="space-y-2 mt-3 pt-3 border-t border-gray-100">
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 w-3.5 h-3.5">
                            <span class="ml-2 text-[11px] text-gray-700">Featured Product</span>
                        </label>
                        <label class="flex items-center">
                            <input type="checkbox" name="is_best_seller" value="1" {{ old('is_best_seller') ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 w-3.5 h-3.5">
                            <span class="ml-2 text-[11px] text-gray-700">Best Seller</span>
                        </label>
                        <label class="flex items-center">
                            <input type="checkbox" name="is_trending" value="1" {{ old('is_trending') ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 w-3.5 h-3.5">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <h3 class="text-xs font-semibold text-gray-800 mb-3 border-b border-gray-100 pb-2 uppercase tracking-wide">Main Image <span class="text-red-500">*</span></h3>
                
                <div class="mt-2" x-data="imageViewer()">
                    <div class="flex items-center justify-center w-full">
                        <label for="main_image" class="flex flex-col items-center justify-center w-full h-40 border border-gray-300 border-dashed rounded-md cursor-pointer bg-gray-50 hover:bg-gray-100 overflow-hidden relative transition @error('main_image') border-red-500 @enderror">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <div class="mt-2">
                    <label class="block text-[10px] font-medium text-gray-700 mb-1 uppercase tracking-wider">Upload multiple images</label>
                    ...
                    <p class="text-[9px] text-gray-400 mt-1.5">You can select multiple files at once. Max 10MB per image.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-md transition shadow-sm flex justify-center items-center gap-1.5 text-[11px]">
                    <span class="material-symbols-outlined text-[16px]">save</span> Save Product
                </button>
            </div>
        </div>
    </div>
