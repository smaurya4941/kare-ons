            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <input type="text" name="seo_title" id="seo_title" value="{{ old('seo_title') }}" placeholder="Falls back to the category name" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">
                    </div>
                    <div>
                        ...
                        <textarea name="seo_description" id="seo_description" rows="2" maxlength="1000" class="w-full border border-gray-200 rounded-md px-3 py-1.5 text-[11px] focus:ring-indigo-500 focus:border-indigo-500 shadow-sm">{{ old('seo_description') }}</textarea>
                    </div>
